...
class ShapeButton @JvmOverloads constructor(
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.ShapeButton).apply {
            mShapeMode = getInt(R.styleable.ShapeButton_ShapeButton_shapeMode, 0)
            mFillColor = getColor(R.styleable.ShapeButton_ShapeButton_fillColor, 0xFFFFFFFF.toInt())
            mPressedColor = getColor(R.styleable.ShapeButton_ShapeButton_pressedColor, 0xFF666666.toInt())
            mStrokeColor = getColor(R.styleable.ShapeButton_ShapeButton_strokeColor, 0)
            mStrokeWidth = getDimensionPixelSize(R.styleable.ShapeButton_ShapeButton_strokeWidth, 0)
            mCornerRadius = getDimensionPixelSize(R.styleable.ShapeButton_ShapeButton_cornerRadius, 0)
            mCornerPosition = getInt(R.styleable.ShapeButton_ShapeButton_cornerPosition, -1)
            mActiveEnable = getBoolean(R.styleable.ShapeButton_ShapeButton_activeEnable, false)
            mDrawablePosition = getInt(R.styleable.ShapeButton_ShapeButton_drawablePosition, -1)
            mStartColor = getColor(R.styleable.ShapeButton_ShapeButton_startColor, 0xFFFFFFFF.toInt())
            mEndColor = getColor(R.styleable.ShapeButton_ShapeButton_endColor, 0xFFFFFFFF.toInt())
            mOrientation = getColor(R.styleable.ShapeButton_ShapeButton_orientation, 0)
            recycle()
        }
    }
