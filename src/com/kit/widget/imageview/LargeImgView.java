...
public class LargeImgView extends ImageView {
    ...
    public static final Class TAG = LargeImgView.class;
    ...
    public void setImageBitmap1(final Bitmap bm) {
        ...
        startAnimation(AnimationUtils.loadAnimation(cxt, R.anim.zoom_in));
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    ZogUtils.printLog(TAG, "sh=" + sh + ",h=" + h + ",count=" + count + ",Build.VERSION.SDK_INT=" + Build.VERSION.SDK_INT);
                    if(Build.VERSION.SDK_INT>1000){//因兼容低版本问题，暂不使用此切图方式
                        InputStream is = BitmapUtils.bitmap2InputStream(bm);
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(android.os.Message msg) {
            ZogUtils.printLog(TAG, "get notify...");
            postInvalidate();
        }
    };
}
