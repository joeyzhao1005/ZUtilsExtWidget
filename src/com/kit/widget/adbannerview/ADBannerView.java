 ...
 * 
 */
public class ADBannerView extends AdapterView<Adapter> {
	...
	public ADBannerView(Context context, int sideBuffer) {
		super(context);
	...
	public ADBannerView(Context context, AttributeSet attrs) {
		...
		mSideBuffer = styledAttrs.getInt(
				R.styleable.ADBannerView_ADBannerView_sidebuffer, 3);
		init();
	}
	 ...
	 * @param flowIndicator
	 */
	public void setFlowIndicator(Indicator flowIndicator) {
		mIndicator = flowIndicator;
		mIndicator.setADBannerView(this);
	}
	...
	public int getCurrIndicatorNum() {
		return (mCurrentAdapterIndex + 1) % mSideBuffer;
	}

	public int getCurrIndexNum() {
		return mCurrentAdapterIndex;
	}
}
